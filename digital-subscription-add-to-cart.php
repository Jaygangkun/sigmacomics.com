...
//echo "<pre>"; print_r($countryCurrency);die;
?>
                ...
                <?php if(!empty($products['product'])){ ?>
                    ...
                    <div class="indidetailBody">
                        ...
                        <div class="rightContentTxt">
                            ...
                            <div class="priceprt">
                                <span>List price: <del><?php echo ( isset($products['product']['variants'][0]['compare_at_price']) )? calculateCurrencyAmount($countryCurrency,$countryCurrencyRate,$products['product']['variants'][0]['compare_at_price']):''; ?></del></span>
                                <span>price: <b><?php echo ( isset($products['product']['variants'][0]['price']) )?calculateCurrencyAmount($countryCurrency,$countryCurrencyRate,$products['product']['variants'][0]['price']):''; ?> !</b></span>
                                <?php if( isset($products['product']['variants'][0]['compare_at_price']) && isset($products['product']['variants'][0]['price']) && ( intval($products['product']['variants'][0]['compare_at_price']) > intval($products['product']['variants'][0]['price']) ) ){ ?>
                                    <span>You save: <font><?php echo calculateCurrencyAmount($countryCurrency,$countryCurrencyRate,$products['product']['variants'][0]['compare_at_price'] - $products['product']['variants'][0]['price'])  ?></font></span>
                                <?php }else{ ?>
                            ...
                            <button class="cartbutton" onclick="addToCartIndividual(<?php echo $products['product']['id'];?>,<?php echo $products['product']['variants'][0]['price'];?>,'DS');">ADD TO CART!</button>
...
<script>
    ...
    let countryCurrencyCode = "<?php echo (isset($countryCurrency->geoplugin_countryCode))?$countryCurrency->geoplugin_countryCode:null;?>";
    ...
    $('.indi_list > h4')
        .text(htmlShortHeadingText.replace(htmlShortHeadingArray[0]+" "+htmlShortHeadingArray[1],calculateCurrencyAmount(countryCurrency,countryCurrencyRate,htmlShortHeadingArray[1],countryInfo)));
    ...
    $('.rightContentTxt > div:nth-child(3) > span > strong')
        .text(htmlShortHeadingText2.replace(htmlShortHeadingArray2[1],calculateCurrencyAmount(countryCurrency,countryCurrencyRate,htmlShortHeadingArray[1],countryInfo)));
</script>
</html>