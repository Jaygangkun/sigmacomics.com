...
if (isset($_SESSION['add_to_cart_session_id']) && $_SESSION['add_to_cart_session_id'] != '' ){
    ...
    $sqlNew = "SELECT SUM(quantity) as total_quantity,sum(price) as total_price FROM `cart` where `session_id`= '".$_SESSION['add_to_cart_session_id']."' and `language` = 'es_ES'";
        ...
        <div class="container">
            <div class="cartWrap">
                ...
                <div class="rightcrtprice">
                    ...
                    <a href="<?php echo constant("SITEURL_SPANISH")?>/checkout"><button class="redbutton">
