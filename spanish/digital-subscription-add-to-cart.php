...
// product data
$data = array("collection_id" => '237255786661');
...
?>
                    ...
                    <?php if(!empty($products['product'])){ ?>
                        ...
                        <div class="indidetailBody">
                            ...
                            <div class="rightContentTxt">
                                ...
                                <div class="priceprt">
                                    <span>Precio de Lista: <del><?php echo ( isset($products['product']['variants'][0]['compare_at_price']) )?calculateCurrencyAmount($countryCurrency,$countryCurrencyRate,$products['product']['variants'][0]['compare_at_price']):''; ?></del></span>
                                    <span>¡Precio: <b><?php echo ( isset($products['product']['variants'][0]['price']) )?calculateCurrencyAmount($countryCurrency,$countryCurrencyRate,$products['product']['variants'][0]['price']):''; ?> !</b></span>
                                    <?php if( isset($products['product']['variants'][0]['compare_at_price']) && isset($products['product']['variants'][0]['price']) && ( intval($products['product']['variants'][0]['compare_at_price']) > intval($products['product']['variants'][0]['price']) ) ){ ?>
                                        <span>Usted Ahorra: <font><?php echo calculateCurrencyAmount($countryCurrency,$countryCurrencyRate,$products['product']['variants'][0]['compare_at_price'] - $products['product']['variants'][0]['price']) ?></font></span>
                                    <?php }else{ ?>
                                        <span>Usted Ahorra: <font>$0</font></span>
                                    <?php } ?>

                                </div>
                                <?php echo ( isset($products['product']['body_html']) )?$products['product']['body_html']:''; ?>

                                <button class="cartbutton" onclick="addToCartIndividualSpanish(<?php echo $products['product']['id'];?>,<?php echo $products['product']['variants'][0]['price'];?>,'DS');">AÑADIR AL CARRITO</button>
    ...
    <script>
        ...
        console.log(calculateCurrencyAmount(countryCurrency,countryCurrencyRate,50,countryInfo));
        console.log(compareAtPrice+" "+Price+" "+youSavePrice);
        /* console.log(countryCurrency);
        ...
        $('.indi_list > h4')
            .text(htmlShortHeadingText.replace(htmlShortHeadingArray[1]+" "+htmlShortHeadingArray[2],calculateCurrencyAmount(countryCurrency,countryCurrencyRate,htmlShortHeadingArray[2].split(',')[0]+"."+htmlShortHeadingArray[2].split(',')[1],countryInfo)));
        ...
        $('.rightContentTxt > div:nth-child(3) > span > strong')
            .text(htmlShortHeadingText2.replace(htmlShortHeadingArray2[1]+" "+htmlShortHeadingArray2[2],calculateCurrencyAmount(countryCurrency,countryCurrencyRate,htmlShortHeadingArray2[2].split(',')[0]+"."+htmlShortHeadingArray2[2].split(',')[1],countryInfo)));
    </script>
    </html>
<?php die();?>