				...
				if($row == 0){
					...
					if( !empty($customers_search['customers']) ){
						...
						if ($conn->query($sqlRow) === TRUE) {
							$_SESSION['message'] = "¡ESTUPENDO! ¡AHORA PUEDE INICIAR SESIÓN ABAJO!";
						} else {
					...
					$_SESSION['message'] = '¡Ya existe el correo electrónico!';
					header( 'Location:'.constant('SITEURL_SPANISH').'/signup');
					exit();
				}
			}
			...
			<div class="thankyoubody">
				...
				<div class="signlogpanel">
					<div class="toploginBox passwordbox">
						...
						<button class="redbutton" name="signup_next"><?php echo (isset($content[37]))?$content[37]:'';?></button>
						</form>
