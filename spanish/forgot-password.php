	...
	if( $user_email != '' ){
		...
		if ($result = $conn->query($sql)) {
			...
			if( count($row) > 0 ){
				...
				$retrieve_password_link = constant("SITEURL")."/spanish/reset-password.php?flag=".$encryptedId;
				...
				$mail->addAddress($user_email, 'Sigmacomics');    // Add a recipient     // Add a recipient
				...
				$mail->Body    = '<p><b>HAGA CLIC EN EL "LINK" DE ABAJO:</b></p><p><b>CAMBIA SU CONTRASEÑA : </b><a href="'.$retrieve_password_link.'">LINK DE CONTRASEÑA</a></p>';
				...
				$_SESSION['message'] = "Correo electrónico no asociado con la cuenta";
