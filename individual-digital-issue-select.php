...
$products = shopify_call($token, $shop, "/admin/api/2020-10/collections/233056207013/products.json", $data, 'GET');
...
<body>
	...
	<!-- Header Section End -->
		...
		<div class="container">
			<div class="indi_list">
				<h3>GET INDIVIDUAL DIGITAL ISSUES!</h3>
				...
				<div id="showProduct">
					...
					<?php }else{ ?>
						...
						<li>
							<div class="imgwrap">
								<a href="<?php echo constant("SITEURL")."/individual-digital-issue-select-add-to-cart.php?product=".$data['id'];?>"><img src="<?php echo $data['images'][0]['src'];?>" alt="listimg"></a>
							</div>
							<div class="txtprt">
							<a href="<?php echo constant("SITEURL")."/individual-digital-issue-select-add-to-cart.php?product=".$data['id'];?>"><?php echo $data['title'];?></a>
							</div>
	...
	<script>
		/*$(document).ready(function(){
				$.ajax({ 
					url: SITEURL+"/manage/individual-digital-issue-select-page-loaded.php",
					type: 'POST',
