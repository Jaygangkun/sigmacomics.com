...
if(!isset($_SESSION['user']) && $_SESSION['user']== ''){
	header( 'Location:'. constant("SITEURL").'/japanese/digital-dashboard-login-5');
	exit();
}
...
if( !empty($args_cat) ){
  ...
  $orderArr = $wpdb->get_results("SELECT * FROM `orders` where `user_id`= '".$_SESSION['user']['id']."' and `language` = 'ja_JA' "); 
  //print_r($orderArr);
  if( !empty($orderArr) ){
    ...
    <a href="<?php echo get_the_permalink($data->ID); ?>" class="readbuy-btn">読み取り</a>
    ...
    <?php }else{ ?>
      ...
      <article><h2>
      <a href="<?php echo constant("SITEURL");?>/japanese/individual-digital-issue-select-add-to-cart.php?product=<?php echo $value;?>">
      <?php echo $data->post_title;?></a> </h2> 
      <a href="<?php echo constant("SITEURL");?>/japanese/individual-digital-issue-select-add-to-cart.php?product=<?php echo $value;?>" class="digibuy-btn">購入</a>
			<p><?php echo get_the_excerpt($data->ID); ?></p>
			</article>
    	</li>
...
?>
<!--<li>
	<figure><img src="<?php echo constant("SITEURL");?>/japanese/images/digital-subscription-icon.jpg" alt="" class="img-fit"></figure>
    <article><h2><a href="<?php echo constant("SITEURL");?>/japanese/digital-subscription-add-to-cart">DIGITAL SUBSCRIPTION</a></h2><a href="<?php echo constant("SITEURL");?>/japanese/digital-subscription-add-to-cart" class="digibuy-btn">読み取り</a>
...
<li>
<?php if ( is_active_sidebar( 'digital-subscription-box-japanese' ) ) : 
					dynamic_sidebar('digital-subscription-box-japanese');
			 endif; ?>
</li>
<?php
	foreach($args_cat->posts as $key=>$data)
    ...
    <h2><a href="<?php echo constant("SITEURL");?>/japanese/individual-digital-issue-select-add-to-cart.php?product=<?php echo $value;?>"><?php echo $data->post_title;?></a></h2>
