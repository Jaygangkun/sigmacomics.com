...
if(!isset($_SESSION['user']) && $_SESSION['user']== ''){
	header( 'Location:'. constant("SITEURL").'/dutch/digital-dashboard-login-7');
	exit();
}
...
if( !empty($args_cat) ){
  ...
  if( !empty($orderArr) ){
    ...
    <?php }else{ ?>
      ...
      <article><h2>
      <a href="<?php echo constant("SITEURL");?>/dutch/individual-digital-issue-select-add-to-cart.php?product=<?php echo $value;?>">
      <?php echo $data->post_title;?></a> </h2> 
      <a href="<?php echo constant("SITEURL");?>/dutch/individual-digital-issue-select-add-to-cart.php?product=<?php echo $value;?>" class="digibuy-btn">ACQUISTA</a>
			<p><?php echo get_the_excerpt($data->ID); ?></p>
			</article>
    	</li>
...
?>
<!--<li>
	<figure><img src="<?php echo constant("SITEURL");?>/dutch/images/digital-subscription-icon.jpg" alt="" class="img-fit"></figure>
    <article><h2><a href="<?php echo constant("SITEURL");?>/dutch/digital-subscription-add-to-cart">DIGITAL SUBSCRIPTION</a></h2><a href="<?php echo constant("SITEURL");?>/dutch/digital-subscription-add-to-cart" class="digibuy-btn">LEGGI</a>
...
<li>
<?php if ( is_active_sidebar( 'digital-subscription-box-dutch' ) ) : 
					dynamic_sidebar('digital-subscription-box-dutch');
			 endif; ?>
</li>
<?php
	foreach($args_cat->posts as $key=>$data)
    ...
    <h2><a href="<?php echo constant("SITEURL");?>/dutch/individual-digital-issue-select-add-to-cart.php?product=<?php echo $value;?>"><?php echo $data->post_title;?></a></h2>
