...
if(!isset($_SESSION['user']) && $_SESSION['user']== ''){
	header( 'Location:'. constant("SITEURL").'/danish/digital-dashboard-login-8');
	exit();
}
...
if( !empty($args_cat) ){
  ...
  $orderArr = $wpdb->get_results("SELECT * FROM `orders` where `user_id`= '".$_SESSION['user']['id']."' and `language` = 'da_DK' "); 
  //print_r($orderArr);
  if( !empty($orderArr) ){
    ...
    <a href="<?php echo get_the_permalink($data->ID); ?>" class="readbuy-btn">LEGGI</a>
    ...
    <?php }else{ ?>
      ...
      <article><h2>
      <a href="<?php echo constant("SITEURL");?>/danish/individual-digital-issue-select-add-to-cart.php?product=<?php echo $value;?>">
      <?php echo $data->post_title;?></a> </h2> 
      <a href="<?php echo constant("SITEURL");?>/danish/individual-digital-issue-select-add-to-cart.php?product=<?php echo $value;?>" class="digibuy-btn">ACQUISTA</a>
			<p><?php echo get_the_excerpt($data->ID); ?></p>
			</article>
    	</li>
...
?>
<!--<li>
	<figure><img src="<?php echo constant("SITEURL");?>/danish/images/digital-subscription-icon.jpg" alt="" class="img-fit"></figure>
    <article><h2><a href="<?php echo constant("SITEURL");?>/danish/digital-subscription-add-to-cart">DIGITAL SUBSCRIPTION</a></h2><a href="<?php echo constant("SITEURL");?>/danish/digital-subscription-add-to-cart" class="digibuy-btn">LEGGI</a>
...
<li>
<?php if ( is_active_sidebar( 'digital-subscription-box-danish' ) ) : 
					dynamic_sidebar('digital-subscription-box-danish');
			 endif; ?>
</li>
<?php
	foreach($args_cat->posts as $key=>$data)
    ...
    <h2><a href="<?php echo constant("SITEURL");?>/danish/individual-digital-issue-select-add-to-cart.php?product=<?php echo $value;?>"><?php echo $data->post_title;?></a></h2>
