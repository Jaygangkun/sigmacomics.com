...
if(!isset($_SESSION['user']) && $_SESSION['user']== ''){
	header( 'Location:'. constant("SITEURL").'/french/digital-dashboard-login-3');
	exit();
}
...
if( !empty($args_cat) ){
  ...
  $orderArr = $wpdb->get_results("SELECT * FROM `orders` where `user_id`= '".$_SESSION['user']['id']."' and `language` = 'fr_FR' "); 
  //print_r($orderArr);
  if( !empty($orderArr) ){
    ...
    <a href="<?php echo get_the_permalink($data->ID); ?>" class="readbuy-btn">LIRE</a>
    ...
    <?php }else{ ?>
      ...
      <article><h2>
      <a href="<?php echo constant("SITEURL");?>/french/individual-digital-issue-select-add-to-cart.php?product=<?php echo $value;?>">
      <?php echo $data->post_title;?></a> </h2> 
      <a href="<?php echo constant("SITEURL");?>/french/individual-digital-issue-select-add-to-cart.php?product=<?php echo $value;?>" class="digibuy-btn">ACHETER</a>
			<p><?php echo get_the_excerpt($data->ID); ?></p>
			</article>
    	</li>
...
?>
<!--<li>
	<figure><img src="<?php echo constant("SITEURL");?>/french/images/digital-subscription-icon.jpg" alt="" class="img-fit"></figure>
    <article><h2><a href="<?php echo constant("SITEURL");?>/french/digital-subscription-add-to-cart">DIGITAL SUBSCRIPTION</a></h2><a href="<?php echo constant("SITEURL");?>/french/digital-subscription-add-to-cart" class="digibuy-btn">LIRE</a>
...
<li>
<?php if ( is_active_sidebar( 'digital-subscription-box-french' ) ) : 
					dynamic_sidebar('digital-subscription-box-french');
			 endif; ?>
</li>
<?php
	foreach($args_cat->posts as $key=>$data)
    ...
    <h2><a href="<?php echo constant("SITEURL");?>/french/individual-digital-issue-select-add-to-cart.php?product=<?php echo $value;?>"><?php echo $data->post_title;?></a></h2>
