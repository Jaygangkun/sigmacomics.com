...
if (isset($_SESSION['add_to_cart_session_id']) && $_SESSION['add_to_cart_session_id'] != '' ){
    ...
    $sqlNew = "SELECT SUM(quantity) as total_quantity,sum(price) as total_price FROM `cart` where `session_id`= '".$_SESSION['add_to_cart_session_id']."' and `language` = 'ja_JA' ";
...
$countryCurrencySymbol = (isset($countryCurrency->geoplugin_currencySymbol_UTF8))?$countryCurrency->geoplugin_currencySymbol_UTF8:"$";
        ...
        <div class="container">
            <div class="cartWrap">
                                    ...
                                    if(!empty($products['product'])){
                                        ...
                                        <tr>
                                            ...
                                            <td valign="top" title="price" title="price">
                                                <b> <?php echo calculateCurrencyAmountWithNullValue($countryCurrency,$countryCurrencyRate,$row['price']);?> </b>
                                            </td>
                                        </tr>
                ...
                <div class="rightcrtprice">
                    <h4><?php echo (isset($content[18]))?$content[18]:'';?>(<?php echo ( isset($total_quantity) && $total_quantity != '' )?$total_quantity:'0'; ?>): <b> <?php echo ( isset($total_price) && $total_price != '' )?calculateCurrencyAmountWithNullValue($countryCurrency,$countryCurrencyRate,$total_price):$countryCurrencySymbol.'0.00'; ?> </b></h4>
                    <a href="<?php echo constant("SITEURL_JAPANESE")?>/checkout"><button class="redbutton">
