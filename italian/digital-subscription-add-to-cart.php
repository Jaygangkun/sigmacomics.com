...
// product data
$data = array("collection_id" => '262992756901');
...
?>
                    ...
                    <?php if(!empty($products['product'])){ ?>
                        ...
                        <div class="indidetailBody">
                            ...
                            <div class="rightContentTxt">
                                ...
                                <div class="priceprt">
                                    <span>Prezzo di Listino: <del><?php echo ( isset($products['product']['variants'][0]['compare_at_price']) )?calculateCurrencyAmount($countryCurrency,$countryCurrencyRate,$products['product']['variants'][0]['compare_at_price']):''; ?></del></span>
                                    <span>Prezzo: <b><?php echo ( isset($products['product']['variants'][0]['price']) )?calculateCurrencyAmount($countryCurrency,$countryCurrencyRate,$products['product']['variants'][0]['price']):''; ?> !</b></span>
                                    <?php if( isset($products['product']['variants'][0]['compare_at_price']) && isset($products['product']['variants'][0]['price']) && ( intval($products['product']['variants'][0]['compare_at_price']) > intval($products['product']['variants'][0]['price']) ) ){ ?>
                                        <span>Risparmi: <font><?php echo calculateCurrencyAmount($countryCurrency,$countryCurrencyRate,$products['product']['variants'][0]['compare_at_price'] - $products['product']['variants'][0]['price']) ?></font></span>
                                    <?php }else{ ?>
                                        <span>Risparmi: <font>$0</font></span>
                                    <?php } ?>

                                </div>
                                <?php echo ( isset($products['product']['body_html']) )?$products['product']['body_html']:''; ?>

                                <button class="cartbutton" onclick="addToCartIndividualItalian(<?php echo $products['product']['id'];?>,<?php echo $products['product']['variants'][0]['price'];?>,'DS');">AGGIUNGI AL CARRELLO</button>
    ...
    <script>
        ...
        $('.indi_list > h4')
            .text(htmlShortHeadingText.replace(htmlShortHeadingArray[0]+" "+htmlShortHeadingArray[1],calculateCurrencyAmount(countryCurrency,countryCurrencyRate,htmlShortHeadingArray[0].split('$')[1],countryInfo)));
        ...
        $('.rightContentTxt > div:nth-child(3) > span > strong')
            .text(htmlShortHeadingText2.replace(htmlShortHeadingArray2[0]+" "+htmlShortHeadingArray2[1],calculateCurrencyAmount(countryCurrency,countryCurrencyRate,htmlShortHeadingArray2[0].split('$')[1],countryInfo)));
    </script>
    </html>
<?php die();?>