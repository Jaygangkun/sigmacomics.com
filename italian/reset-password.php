			...
			if ($result = $conn->query($sql)) {
				...
				if($row['total'] > 0){
					...
					if ($conn->query($sql) === TRUE) {
						header( 'Location:'.constant('SITEURL_ITALIAN').'/reset-password-2.php');
					}
				}
			}else {
				$_SESSION['message'] =  "Error: " . $sql . "<br>" . $conn->error;
				header( 'Location:'.constant('SITEURL_ITALIAN').'/forgot-password');
				exit();
			}
		}
	}
			...
			<div class="loginWrap">
				<div class="toploginBox">
					...
					<div class="form-group">
						<p class="bigTxt">Inserisci la password con il tuo account.</p>
					</div>
					<div class="form-group">
						<div class="labelwrap">
					...
					<button class="getbutton"  name="forgot_pass_next">Invia </button>
					</form>
					<div class="checkboxprt">
					Ancora problemi? Póngase en <a href="<?php echo constant("SITEURL_ITALIAN")."/contact";?>">Entrare in contatto</a>
					</div>
