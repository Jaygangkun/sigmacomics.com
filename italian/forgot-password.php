	...
	if( $user_email != '' ){
		...
		if ($result = $conn->query($sql)) {
			...
			if( count($row) > 0 ){
				...
				$retrieve_password_link = constant("SITEURL")."/italian/reset-password.php?flag=".$encryptedId;
				...
				$mail->Subject = utf8_decode('RECUPERO DELLA PASSWORD');
				$mail->Body    = '<p><b>CLICCA SUL LINK SOTTO:</b></p><p><b>CAMBIA LA TUA PASSWORD : </b><a href="'.$retrieve_password_link.'">LINK PASSWORD</a></p>';
				...
				$_SESSION['message'] = "Email non associata all'account";
