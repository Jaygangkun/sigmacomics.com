...
/*if(!isset($_SESSION['add_to_cart_session_id']) && $_SESSION['add_to_cart_session_id']== ''){
	header( 'Location:'.constant('SITEURL_ITALIAN').'/order-issues-2');
}*/
                ...
                <?php if(!empty($products['product'])){ ?>
                    ...
                    <div class="new-cart-dtl-itm">
                        ...
                        <article>
                            ...
                            <button class="cartbutton" onclick="addToCartIndividualItalian(<?php echo $_GET['product'];?>,<?php echo $products['product']['variants'][0]['price'];?>,'DS');">AGGIUNGI AL CARRELLO</button>
                        </article>
                    </div>
                <?php }else{
