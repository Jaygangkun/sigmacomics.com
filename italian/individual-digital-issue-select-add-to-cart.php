				...
				<div id="showProduct" >
					<div class="indidetailBody">
						...
						<h3><?php echo ( isset($products['product']['title']) )?$products['product']['title']:'';?> </h3>
							<div class="priceprt">
								<span>Prezzo di Listino: <del>USD<?php echo ( isset($products['product']['variants'][0]['compare_at_price']) )?$products['product']['variants'][0]['compare_at_price']:''; ?></del></span>
								<span>Prezzo: <b>USD<?php echo ( isset($products['product']['variants'][0]['price']) )?$products['product']['variants'][0]['price']:''; ?> !</b></span>
								<?php if( isset($products['product']['variants'][0]['compare_at_price']) && isset($products['product']['variants'][0]['price']) && ( intval($products['product']['variants'][0]['compare_at_price']) > intval($products['product']['variants'][0]['price']) ) ){ ?>
									<span>Risparmi: <font>USD<?php echo $products['product']['variants'][0]['compare_at_price'] - $products['product']['variants'][0]['price'] ?></font></span>
								<?php }else{ ?> 
									<span>Risparmi: <font>USD 0</font></span>
								<?php } ?>
								
							</div>
							<?php echo ( isset($products['product']['body_html']) )?$products['product']['body_html']:''; ?>
							
							<button class="cartbutton" onclick="addToCartIndividualItalian('<?php echo $_GET['product'];?>','<?php echo $products['product']['variants'][0]['price'];?>','IDI');">AGGIUNGI AL CARRELLO</button>
