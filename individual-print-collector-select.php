...
// Individual Print Collector Issue =>229840158885
...
$products = shopify_call($token, $shop, "/admin/api/2020-10/collections/233056338085/products.json", $data, 'GET');

//$data = array();
//$customer = shopify_call($token, $shop, "/admin/api/2020-10/custom_collections.json", $data, 'GET');
...
<body>
	...
	<!-- Header Section End -->
		...
		<div class="container">
			<div class="indi_list">
				<h3>GET INDIVIDUAL PRINT *COLLECTOR ISSUES!</h3>
				<h4>ONLY $3.99 EACH!</h4>
				...
				<?php }else{ ?>
					<li>
						<div class="imgwrap">
							<a href="<?php echo constant("SITEURL")."/individual-print-collector-add-to-cart.php?product=".$data['id'];?>"><img src="<?php echo $data['images'][0]['src'];?>" alt="listimg"></a>
						</div>
						<div class="txtprt">
						<a href="<?php echo constant("SITEURL")."/individual-print-collector-add-to-cart.php?product=".$data['id'];?>"><?php echo $data['title'];?></a>
						</div>
