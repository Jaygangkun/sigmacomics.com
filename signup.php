			...
			<div class="thankyoubody">
				...
				<div class="signlogpanel">
					<div class="toploginBox">
						...
						<label><?php echo utf8_encode((isset($content[39]))?$content[39]:'');?></label>
							<input type="text" class="form-control" name="user_email">
						</div>
						<button class="redbutton" name="signup_next"><?php echo utf8_encode((isset($content[40]))?$content[40]:'');?></button>
						</form>
					...
					<div class="toploginBox">
						...
						<button class="redbutton" name="login_next"><?php echo utf8_encode((isset($content[40]))?$content[40]:'');?></button>
						</form>
						<p><?php echo (isset($content[2]))?$content[2]:'';?></p>
					</div>
				</div>
