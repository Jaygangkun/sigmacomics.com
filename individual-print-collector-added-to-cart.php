		...
		<div class="container">
			<div class="new-add-cart-top-sec">
				<ul>
					...
					<li class="buy-more-btn"><a href="<?php echo constant("SITEURL")."/individual-print-collector-select";?>">Buy More</a></li>
			...
			<div class="cartImgprt">
				...
				<article>
					...
					<button class="cartbutton" onclick="addToCartIndividual(<?php echo $_GET['product'];?>,<?php echo $products['product']['variants'][0]['price'];?>,'IPC');">ADD TO CART!</button>
				</article>
			</div>
			<?php
					}else{
