...
// product data
$data = array("collection_id" => '233056403621');
...
<body>
	...
	<section class="inner-page-body-sec news-page-body">
			<div class="container">
				<div class="indi_list">
					<h3>GET A PRINT *READER SUBSCRIPTION!</h3>
				...
				<div class="indidetailBody">
					...
					<div class="rightContentTxt">
						...
						<button class="cartbutton" onclick="addToCartIndividual(<?php echo $products['product']['id'];?>,<?php echo $products['product']['variants'][0]['price'];?>,'PRS');">ADD TO CART!</button>
