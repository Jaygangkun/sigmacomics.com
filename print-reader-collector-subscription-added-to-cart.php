	...
	<section class="inner-page-body-sec new-add-to-cart">
		<div class="container">
			<div class="new-add-cart-top-sec">
				<ul>
					<li class="selected-cart">
						<p><img src="<?php echo constant("SITEURL");?>/images/right-tick.png" alt=""> Add to cart!</p>
					</li>
					<li class="total-cart-itm">
						<p>cart subtotal (<?php echo $total_quantity; ?> item): $<?php echo $total_price;?></p>
					</li>
					<li class="buy-more-btn"><a href="<?php echo constant("SITEURL")."/order-issues";?>">BUY MORE</a></li>
			...
			<div class="new-cart-dtl-itm-hdn">
				<h2>OR...GET A SIGMA COMICS CAP...FOR YOU...OR A FRIEND!</h2>
				<h3>STAND IN SOLIDARITY...WITH SIGMA!</h3>
			</div>
