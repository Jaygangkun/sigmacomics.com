		...
		<div class="container">
			<div class="new-add-cart-top-sec">
				<ul>
					...
					<li class="buy-more-btn"><a href="<?php echo constant("SITEURL")."/cart";?>"><?php echo (isset($content[44]))?$content[44]:'';?></a></li>
					<li class="proceed-checkout-btn"><a href="<?php echo constant("SITEURL")."/checkout";?>"><?php echo (isset($content[45]))?$content[45]:'';?>  (<?php echo $total_quantity; ?> <?php echo (isset($content[46]))?$content[46]:'';?>)</a></li>
				</ul>
			</div>
			...
			<div class="new-cart-dtl-itm">
				...
				<article>
					...
					<button class="cartbutton" onclick="addToCartIndividual(<?php echo $_GET['product'];?>,<?php echo $products['product']['variants'][0]['price'];?>,'DS');">ADD TO CART!</button>
				</article>
			</div>
			<?php }else{  
...
<script>
    ...
    $('.new-cart-dtl-itm > article > h2 > div:nth-child(1) > span > strong').text(
        htmlPerIssuePriceText.replace(htmlPerIssuePriceText.split(' ')[1],calculateCurrencyAmount(countryCurrency,countryCurrencyRate,htmlPerIssuePriceText.split(' ')[1].split('$')[1],countryInfo)));
</script>
</html>