			...
			if ($result = $conn->query($sql)) {
				...
				if($row['total'] > 0){
					...
					if ($conn->query($sql) === TRUE) {
						header( 'Location:'.constant('SITEURL_FRENCH').'/reset-password-2.php');
					}
				}
			}else {
				$_SESSION['message'] =  "Error: " . $sql . "<br>" . $conn->error;
				header( 'Location:'.constant('SITEURL_FRENCH').'/forgot-password');
				exit();
			}
		}
	}
			...
			<div class="loginWrap">
				<div class="toploginBox">
					...
					<div class="form-group">
						<p class="bigTxt">Entrez le mot de passe avec votre compte.</p>
					</div>
					<div class="form-group">
						<div class="labelwrap">
					...
					<button class="getbutton"  name="forgot_pass_next">Envoyer </button>
					</form>
					<div class="checkboxprt">
					Vous rencontrez toujours des problèmes? <a href="<?php echo constant("SITEURL_FRENCH")."/contact";?>">Contactez-nous.</a>
					</div>
