	...
	if( $user_email != '' ){
		...
		if ($result = $conn->query($sql)) {
			...
			if( count($row) > 0 ){
				...
				$retrieve_password_link = constant("SITEURL")."/french/reset-password.php?flag=".$encryptedId;
				...
				$mail->Subject = utf8_decode('LIEN DE RÉCUPÉRATION DE MOT DE PASSE');
				$mail->Body    = '<p><b>CLIQUEZ SUR LE LIEN CI-DESSOUS:</b></p><p><b>CHANGEZ VOTRE MOT DE PASSE : </b><a href="'.$retrieve_password_link.'">Lien de mot de passe</a></p>';
				$mail->Send();
				...
				$_SESSION['message'] = "E-mail non associé au compte";
