...
// product data
$data = array("collection_id" => '233056436389');
...
<body>
	...
	<section class="inner-page-body-sec news-page-body">
			<div class="container">
				<div class="indi_list">
					<h3>GET A PRINT *COLLECTOR SUBSCRIPTION!</h3>
					<h4>ALL 8-ISSUES! FREE SHIPPING!</h4>
				</div>
				<div class="indidetailBody">
					...
					<div class="rightContentTxt">
						...
						<button class="cartbutton" onclick="addToCartIndividual(<?php echo $products['product']['id'];?>,<?php echo $products['product']['variants'][0]['price'];?>,'PCS');">ADD TO CART!</button>
