	...
	if( $user_email != '' ){
		...
		if ($result = $conn->query($sql)) {
			...
			if( count($row) > 0 ){
				...
				$retrieve_password_link = constant("SITEURL")."/german/reset-password.php?flag=".$encryptedId;
				...
				$mail->Subject = utf8_decode('PASSWORT-WIEDERHERSTELLUNG');
				$mail->Body    = '<p><b>KLICKEN SIE AUF DEN LINK UNTEN:</b></p><p><b>ÄNDERN SIE IHR PASSWORT : </b><a href="'.$retrieve_password_link.'">PASSWORT-LINK</a></p>';
