...
// product data
$data = array("collection_id" => '233056469157');
...
<body>
	...
	<?php if(!empty($products['product'])){ ?>
		...
		<section class="inner-page-body-sec news-page-body">
				<div class="container">
					<div class="indi_list">
						<h3>GET A PRINT READER & DIGITAL SUBSCRIPTION!</h3>
						<h4>GET ALL 8-ISSUES - ***FREE SHIPPING!***</h4>
					</div>
					<div class="indidetailBody">
						...
						<div class="rightContentTxt">
							...
							<button class="cartbutton" onclick="addToCartIndividual(<?php echo $products['product']['id'];?>,<?php echo $products['product']['variants'][0]['price'];?>,'PRDS');">ADD TO CART!</button>
