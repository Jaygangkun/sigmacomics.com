...
// Shop => 225130545317
// Print Reader Subscription => 229842583717
// Print Collector Subscription=> 229843894437

// product data
$data = array("collection_id" => '233056567461');
...
/*$data = array();
$collection = shopify_call($token, $shop, "/admin/api/2020-10/custom_collections.json", $data, 'GET');
$collection = json_decode($collection['response'], TRUE);
...
<body>
	...
	<section class="inner-page-body-sec news-page-body">
			...
			<?php if(!empty($products['product'])){ ?>
				...
				<div class="indi_list">
					<h3>GET A PRINT READER COLLECTOR SUBSCRIPTION!</h3>
					<h4>GET 16 PRINT ISSUES - ***FREE SHIPPING ON 8 ISSUES!***</h4>
				</div>
				<div class="indidetailBody">
					...
					<div class="rightContentTxt">
						...
						<button class="cartbutton" onclick="addToCartIndividual(<?php echo $products['product']['id'];?>,<?php echo $products['product']['variants'][0]['price'];?>,'PRCS');">ADD TO CART!</button>
